...
def profile_unlogged() -> None:
    """ Test for accessing profile when not logged in """
    cookies = {
        "session_id": ""
    }
...
def profile_logged(session_id: str) -> None:
    """ Test for accessing profile when logged in """
    cookies = {
...
def reset_password_token(email: str) -> str:
    """ Test for getting a password reset token """
    data = {
        "email": email
    }
...
def update_password(email: str, reset_token: str, new_password: str) -> None:
    """ Test for updating password using reset token """
    data = {
        "email": email,
